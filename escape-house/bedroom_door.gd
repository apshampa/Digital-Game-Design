...
func interact():
	...
	# Start code input
	input_code = ""
	dialogue_text.text = "Order - From the coldest silence, to the restless flame, to the waiting table. ENTER CODE: _ _ _"
...
func update_display(dialogue_text):
	...
	dialogue_text.text = "Order - From the coldest silence, to the restless flame, to the waiting table. ENTER CODE: " + display
...
func enter_bedroom(dialogue_text):
	...
	dialogue_text.text = "The door slowly opens..."
